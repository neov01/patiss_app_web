            ...
            {activeTab === 'identity' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div>
                  ...
                  <input {...register('fullName')} className="input" placeholder="ex: Marie Konan" />
                ...
                <div>
                  ...
                  <input {...register('phone')} className="input" type="tel" placeholder="ex: +225 07 00 00 00" />
                </div>
                ...
                <div>
                  ...
                  <input {...register('hireDate')} className="input" type="date" />
                </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                ...
                <div>
                  <label className="label">
                    Code PIN (4 chiffres){mode === 'edit' && <span style={{ fontWeight: 400, color: 'var(--color-muted)', textTransform: 'none', letterSpacing: 0, marginLeft: '6px' }}>— laisser vide pour ne pas changer</span>}
                  </label>
                ...
                {/* Salaire de base */}
                <div>
                  <label className="label">Salaire de base mensuel ({currency})</label>
                  <div style={{ position: 'relative' }}>
                    <input
                      ...
                      min={0}
                      placeholder="0"
                      style={{ fontSize: '1.1rem', fontWeight: 700, textAlign: 'right', paddingRight: '64px' }}
                    />
                    <span style={{ position: 'absolute', right: '14px', top: '50%', transform: 'translateY(-50%)', fontSize: '0.8rem', fontWeight: 600, color: 'var(--color-muted)' }}>
                      {currency}
                    </span>
                  </div>
