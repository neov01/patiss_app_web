-- ============================================================
-- Migration : 20260809110004_get_ia_financial_context_exclude_deleted_orders
-- Objectif  : Exclure les commandes supprimées logiquement de tous les
--             agrégats "orders" fournis au contexte financier de l'IA
--             (commandes impayées/à venir/historique, répartitions,
--             top clients, KPI globaux), pour rester cohérent avec le
