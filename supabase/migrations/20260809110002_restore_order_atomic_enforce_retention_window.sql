-- ============================================================
-- Migration : 20260809110002_restore_order_atomic_enforce_retention_window
-- Objectif  : Empêcher la restauration d'une commande dont la fenêtre de
--             rétention de 30 jours est déjà dépassée mais que le job de
--             purge nocturne n'a pas encore traitée (fenêtre entre minuit
--             et l'exécution du cron à 3h, ou incident de purge). La base
--             de données doit être la source de vérité de la règle des 30
--             jours, pas uniquement le calcul client.
-- ============================================================
