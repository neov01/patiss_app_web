-- Création de get_ia_financial_context : fournit tout le contexte métier
-- nécessaire au Comptable IA (Compta-Gâteau) en un seul appel RPC.
-- Couvre 12 mois d'historique + données opérationnelles temps réel.
